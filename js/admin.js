  ...
  const ADMIN_DATA_STORES = ["recipes", "ingredients", "recipeCategories", "ingredientCategories", "menus", "cookingSessions", "familyMembers", "settings", "shoppingList"];
