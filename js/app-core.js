(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "admin.importConfirm": "This will replace ALL current data (recipes, ingredients, menus, shopping list, family members, settings) with the contents of the selected backup file. This cannot be undone. Continue?",
    ...
    ro: {
      ...
      "admin.importConfirm": "Această acțiune va înlocui TOATE datele curente (rețete, produse, meniuri, listă cumpărături, membri familie, setări) cu conținutul fișierului de backup selectat. Acțiunea nu poate fi anulată. Continuați?",
